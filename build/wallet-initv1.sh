...
function init() {
    ...
    echo "=========== # block wait 3 ============="
    block_wait "./chain33-cli" 20

    ./chain33-cli send coins transfer -a 200 -n test -t 14KEKbYtKKQm4wMthSK9J4La4nAiidGozt -k 4257D8692EF7FE13C68B65D6A52F03933DB2FA5CE8FAF210B5B8B80C721CED01
}
